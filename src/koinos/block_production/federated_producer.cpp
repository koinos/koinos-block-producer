...
federated_producer::federated_producer( crypto::private_key signing_key,
  ...
  try
  {
    ...
    do
    {
      ...
      auto block_signature =
        std::string( (const char*)_signing_key.sign_compact( id ).data(), sizeof( crypto::recoverable_signature ) );
...
void federated_producer::commence()
{
  boost::asio::post( _production_context,
                     std::bind( &federated_producer::produce, this, boost::system::error_code{} ) );
}
